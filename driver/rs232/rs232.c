...
#define MAX_PORT_NUM    23
int Cport[MAX_PORT_NUM],
    error;

struct termios new_port_settings,
       old_port_settings[MAX_PORT_NUM];

char comports[MAX_PORT_NUM][13]={"/dev/ttyS0","/dev/ttyS1","/dev/ttyS2","/dev/ttyS3","/dev/ttyS4","/dev/ttyS5",
                       "/dev/ttyS6","/dev/ttyS7","/dev/ttyS8","/dev/ttyS9","/dev/ttyS10","/dev/ttyS11",
                       "/dev/ttyS12","/dev/ttyS13","/dev/ttyS14","/dev/ttyS15","/dev/ttyUSB0",
                       "/dev/ttyUSB1","/dev/ttyUSB2","/dev/ttyUSB3","/dev/ttyUSB4","/dev/ttyUSB5","/dev/ttyAMA0"};
...
int OpenComport(int comport_number, int baudrate)
{
  ...
  if((comport_number>(MAX_PORT_NUM-1))||(comport_number<0))
  {
...
HANDLE Cport[MAX_PORT_NUM];


char comports[MAX_PORT_NUM][10]={"\\\\.\\COM1",  "\\\\.\\COM2",  "\\\\.\\COM3",  "\\\\.\\COM4",
                       "\\\\.\\COM5",  "\\\\.\\COM6",  "\\\\.\\COM7",  "\\\\.\\COM8",
